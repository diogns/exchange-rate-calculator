          ...
          containerDefinitions: JSON.stringify([
            {
              ...
              environment: [
                ...
                {
                  name: 'APIGATEWAY_STAGE_URL_CORE',
                  value: Constants.apiGatewayStageUrlCore as string,
                },
                {
                  name: 'USER_POOL_ID',
                  value: Constants.cognitoUserPoolId as string,
                },
                {
                  name: 'CLIENT_ID',
                  value: Constants.cognitoClientId as string,
                },
              ],
              logConfiguration: {
                logDriver: 'awslogs',
